package Audio::Multitrack::Wav;
our $VERSION = 1.0;
our @ISA; 
use Audio::Multitrack::Object qw(name active dir);
use warnings;
...
sub get_versions {
	...
	my $dir = Audio::Multitrack::this_wav_dir();
	...
	$debug and print "get_version: " , Audio::Multitrack::yaml_out(\%versions);
	closedir WD;
	%versions;
}
