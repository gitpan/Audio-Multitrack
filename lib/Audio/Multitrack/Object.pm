package Audio::Multitrack::Object;
use Carp;
...
BEGIN {
	require 5.004;
	$Audio::Multitrack::Object::VERSION = '1.04';
}

sub import {
	return unless shift eq 'Audio::Multitrack::Object';
	my $pkg   = caller;
	my $child = !! @{"${pkg}::ISA"};
	eval join '',
		"package $pkg;\n",
		...
		' map{ $_is_field{$_}++ } @_;',
		($child ? () : "\@${pkg}::ISA = 'Audio::Multitrack::Object';\n"),
		map {
...
Audio::Multitrack::Object - Class builder
...
=head1 SYNOPSIS
  ...
  use Audio::Multitrack::Object qw{ bar baz };
...
type man Audio::Multitrack::Object
